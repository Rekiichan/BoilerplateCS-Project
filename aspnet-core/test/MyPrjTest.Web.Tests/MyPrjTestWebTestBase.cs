...
{
    public abstract class MyPrjTestWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static MyPrjTestWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(MyPrjTestWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<MyPrjTestDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<MyPrjTestDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<MyPrjTestDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<MyPrjTestDbContext, Task<T>> func)
        {
            T result;
